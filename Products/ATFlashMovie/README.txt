...
* A new content type that stores and displays Macromedia Flash movies.
...
Flash movies should now appear in the image drawer and be insertable into the document. Using IE the Flash movie will appear in the
document and may be edited or moved as desired. Firefox will not play the movie while you are editing, so a 'flash placeholder' image is
displayed instead: you cannot select it in Firefox so if you need to delete a Flash movie you will need to include the image in a slightly
larger selection (e.g. spaces before and after) and delete that.


Credits

  * Jean-Charles ROGEZ (jeancharles.rogez@free.fr)

  * swfHeaderData.py got from http://www.zope.org/Members/sergeyv/CMFFlashMovie

  * christian@daftdog.de (german translation)
